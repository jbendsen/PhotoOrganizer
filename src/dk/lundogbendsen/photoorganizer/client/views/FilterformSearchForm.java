...
public class FilterformSearchForm extends com.smartgwt.client.widgets.form.SearchForm {
    private ComboBoxItem itemName;
    private ButtonItem findItem;


    public FilterformSearchForm(DataSource supplyItemDS) {
        ...
        findInCategory.setTitle("Use Album");
